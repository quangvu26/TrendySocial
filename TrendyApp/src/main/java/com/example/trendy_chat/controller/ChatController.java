...
public class ChatController {
    ...
    /**
     * Get all solo chats for a user
     * GET /trendy/chat/solo?userId=...
     */
    @GetMapping("/solo")
    ...
    /**
     * Hide group message permanently - POST /trendy/chat/group-message/{messageId}/hide
     */
    ...
    public ResponseEntity<?> hideGroupMessagePermanent(@PathVariable String messageId, @RequestParam String userId) {
        try {
            System.out.println("👁️ Hiding group message: " + messageId);
            Optional<?> msgOpt = groupRepo.findById(messageId);
            if (msgOpt.isPresent()) {
                TinNhanNhom groupMsg = (TinNhanNhom) msgOpt.get();
    ...
    /**
     * Delete private message (owner only) - HARD DELETE
     * DELETE /trendy/chat/private/message/{messageId}?userId=...
     */
    ...
    public ResponseEntity<?> deletePrivateMessage(@PathVariable String messageId, @RequestParam String userId) {
        try {
            System.out.println("🗑️ DELETE Private message: " + messageId + " by user: " + userId);
            Optional<TinNhanCaNhan> msgOpt = privateRepo.findById(messageId);
    ...
    public ResponseEntity<?> deleteGroupMessage(@PathVariable String messageId, @RequestParam String userId) {
        try {
            System.out.println("🗑️ DELETE Group message: " + messageId + " by user: " + userId);
            Optional<?> msgOpt = groupRepo.findById(messageId);
    ...
    /**
     * Get group members
     * GET /trendy/chat/group/{maNhom}/members
     */
    ...
    /**
     * Get group info
     * GET /trendy/chat/group/{maNhom}/info
     */
