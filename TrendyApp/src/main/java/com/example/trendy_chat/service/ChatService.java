...
public class ChatService {
    ...
    public TinNhanCaNhan savePrivateMessage(PrivateMessage dto) {
        ...
        try {
            ...
            // Broadcast to conversation topic (match frontend subscription)
            // Frontend subscribes to: /topic/chat/private/{maNhomSolo}
            String conversationTopic = "/topic/chat/private/" + soloChat.getIdSoloChat();
            
            // Create response DTO with proper field names including reply
