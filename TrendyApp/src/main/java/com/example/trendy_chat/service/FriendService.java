...
public class FriendService {
    ...
    /**
     * Cleanup duplicate bidirectional relations
     * Nếu có 2 XAC_NHAN relations giữa cùng 2 người, xóa 1 cái
     * Return: số relations bị xóa
     */
    ...
    /**
     * Check and fix inconsistent friend relations
     * Nếu 1 bên XAC_NHAN nhưng bên kia CHO_DUYET/TU_CHOI, fix thành cùng trạng thái
     */
    ...
    /**
     * Delete all friend relations between two users (bidirectional)
     * Used for unfriending - xóa cả 2 chiều
     */
    ...
    /**
     * Get friend status between two users (bidirectional aware)
    ...
    /**
     * Check if two users are friends (XAC_NHAN status only)
     */
    ...
    /**
     * Accept friend request and update all related requests to XAC_NHAN
     * @return
     */
    ...
    /**
     * Count friends with XAC_NHAN status - both directions
     * Count unique friend IDs from both maNguoiGui and maNguoiNhan perspectives
     */
